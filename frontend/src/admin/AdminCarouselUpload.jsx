...
const AdminCarouselUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        const uploadResponse = await axios.post('https://vtct.onrender.com/api/upload', formData, {
          headers: {
      ...
      if (editingId) {
        await axios.put(`https://vtct.onrender.com/api/carousel/${editingId}`, adData, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
        ...
        await axios.post('https://vtct.onrender.com/api/carousel', adData, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this carousel ad?')) {
      try {
        setLoading(true);
        const token = localStorage.getItem('token');
        await axios.delete(`https://vtct.onrender.com/api/carousel/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
  ...
  const handleToggleActive = async (ad) => {
    try {
      setLoading(true);
      const token = localStorage.getItem('token');
      await axios.put(`https://vtct.onrender.com/api/carousel/${ad._id}`, {
        ...ad,
