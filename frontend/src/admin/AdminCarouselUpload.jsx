...
const AdminCarouselUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const adData = { title, imageUrl: finalImageUrl, description, link, order };
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Image URL */}
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2">Or Image URL</label>
          <input
            type="url"
            className="shadow border rounded w-full py-2 px-3"
            value={imageUrl}
        ...
        <div className="flex gap-2">
          <button
            type="submit"
            className="bg-[#cb1517] hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
            disabled={loading}
          >
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`p-1 ${
                          ad.isActive ? 'bg-orange-500' : 'bg-green-500'
                        } text-white rounded`}
                      >
