...
const Footer = () => {
  ...
  useEffect(() => {
    // Set initial state only (no logo animation)
        ...
        <div className="container mx-auto px-6 pt-16 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="footer-animate">
              ...
              <div className="space-y-3">
                {[
                  { name: 'NEET', url: '/courses/neet' },
                  { name: 'JEE', url: '/courses/jee' },
                  { name: 'MHT-CET', url: '/courses/mht-cet' },
                  { name: 'Foundation Builder', url: '/courses/foundation-builder' }
                ].map((course, index) => (
                  <Link
                    key={index}
                    to={course.url}
                    className="flex items-center text-gray-300 hover:text-white transition-all duration-300 transform hover:translate-x-2 group"
                  >
                    <FaGraduationCap className="mr-3 text-gray-400 text-lg group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="footer-animate">
              ...
              <div className="space-y-4">
                ...
                {[
                  {
                    title: 'Head Office & Classroom No. 1',
                    details: '2nd Floor, Kamdar Shopping Centre, Shop No. 29, Opp. Railway ticket counter, Vile Parle (E), Mumbai - 400 057'
                  },
                  {
                    title: 'Ground Floor',
                    details: 'Naminath Apt, Shop No. 10, Tejpal Road, Opp. Vile Parle Station Bus Stop.'
                  },
                  {
                    title: 'Lecture Hall Classroom No. 2',
                    details: '1st Floor, Kamdar Shopping Centre, Shop No. 3D, Opp. Railway ticket counter, Vile Parle (E), Mumbai - 400 057'
                  },
                  {
                    title: 'Conference Room & Classroom No. 3 & 4, VTC LIBRARY',
                    details: '1st Floor, Kamdar Shopping Centre, Shop No. 3D, Opp. Railway ticket counter, Vile Parle (E), Mumbai - 400 057'
                  }
                ].map((loc, index) => (
                  <div key={index} className="flex items-start group cursor-pointer">
                    ...
                    <div className="text-gray-300 group-hover:text-white transition-colors duration-300 text-sm">
                      <p className="font-semibold mb-1">{loc.title}</p>
                      <p>{loc.details}</p>
                    </div>
                  </div>
                ))}
